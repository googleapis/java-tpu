...
<!-- {x-version-update-start:google-cloud-tpu:released} -->
...
```Groovy
implementation 'com.google.cloud:google-cloud-tpu:2.14.0'
```

If you are using SBT, add this to your dependencies:

```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-tpu" % "2.14.0"
```
...
[maven-version-link]: https://central.sonatype.com/artifact/com.google.cloud/google-cloud-tpu/2.14.0
