      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 10: {
            ...
            identity_ = input.readMessage(com.google.cloud.tpu.v2alpha1.ServiceIdentity.parser(), extensionRegistry);
            if (subBuilder != null) {
  ...
  public static final class Builder extends
    ...
    public Builder mergeFrom(
      ...
      try {
        ...
        parsedMessage = (com.google.cloud.tpu.v2alpha1.GenerateServiceIdentityResponse) e.getUnfinishedMessage();
    ...
    public Builder mergeIdentity(com.google.cloud.tpu.v2alpha1.ServiceIdentity value) {
      if (identityBuilder_ == null) {
        if (identity_ != null) {
          identity_ =
            com.google.cloud.tpu.v2alpha1.ServiceIdentity.newBuilder(identity_).mergeFrom(value).buildPartial();
        } else {
          identity_ = value;
        }
        onChanged();
